    ...
    public double getLength(){
        ...
        if (this.points.length >=4) {
            for (int i = 0; i < this.points.length - 3; i += 2) {
                //System.out.println("("+this.points[i]+"," +this.points[i + 1]+")"+"("+ this.points[i + 2] +","+ this.points[i + 3]+")");
                //System.out.println(calculate((double)this.points[i], (double)this.points[i + 1], (double)this.points[i + 2], (double)this.points[i + 3]));
